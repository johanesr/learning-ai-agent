...
| 3–4 | **Context + data** | SQLite-backed, conflict detection, answers questions about data it had to fetch |
| 5 | **n8n, deliberately** | The same agent rebuilt in n8n. A written comparison: what it saved, what it hid |
| 6–7 | **MCP + real Google Calendar** | OAuth, refresh tokens, your tools as an MCP server in Claude Desktop |
| 8–9 | **Evals** | 25 test phrases, a score you can state as a number |
| 10–11 | **Ship** | FastAPI or Telegram front end, deployed, logged, cost-tracked |
| 12–13 | **Company pilot** | One narrow Odoo process, measured against the manual version |
...
- [ ] `uv run jadwal_week1.py` works from a clean terminal
